  ...
  const { dark, colors, setScheme } = useTheme();
      ...
      const onShare = async () => {
        const result = await Share.share({
          message:
            'I like this app very much ❤️ , use it 🤗 || https://annesiyimwebprojectv1.azurewebsites.net/',
        });
    };
  ...
  const renderProfile = () => {
    ...
    return (
      <View style={styles.profileContainer}>
        ...
        <Text style={[styles.title, { color: dark? COLORS.secondaryWhite : COLORS.greyscale900 }]}>Muhammet Sadık</Text>
        <Text style={[styles.subtitle, { color: dark? COLORS.secondaryWhite : COLORS.greyscale900 }]}>test@test.com</Text>
      </View>
    )
  }
  /**
